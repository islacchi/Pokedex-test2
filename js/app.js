$(document).ready(function(){
    ...
    $(document).on("click", '.cont-pokemon', function(event) { 
        ...
        var pokedexpokemons2 = function(name, id, imagen, hp, attack, defense, specialAttack, specialDefense, speed){
            ...
            + imagen + "' alt='pokemon'><div class ='stats'><div class='cont-h3'>Statistics</div><br><div class='container-info-p'><span class='info-p'>Health Points: " + hp + "</span><br><span class='info-p'>Attack Damage: " 
            ...
            + specialDefense + "</span><br><span class='info-p'>Speed: " + speed + "</span></div><br><center><button class='back' >Back</button></center></div></div>" ;
            return t;
        }
